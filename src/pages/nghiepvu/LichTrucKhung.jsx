...
export default function LichTrucKhung() {
    ...
    const removeGV = async (phong_id, thu, lichId) => {
        ...
        try {
            ...
            await loadData(true); // Hoàn tác: tải lại nếu lỗi
        }
    };
                            ...
                            return [
                                ...
                                <div key={`r-${pid}`} className="khung-cell khung-room-label">
                                    ...
                                    <div style={{ fontSize: '0.7rem', color: '#94a3b8', marginTop: 2 }}>
                                        {phong.sl_diem_danh} ĐD · {phong.sl_ho_tro} GS
                                    </div>
                                </div>,
                                /* Day cells */
                    ...
                    <div className="modal-box">
                        ...
                        <div className="modal-body">
                            ...
                            <p style={{ fontSize: '0.78rem', color: '#94a3b8', marginBottom: 8 }}>
                                Bấm <span style={{ color: '#2563eb', fontWeight: 700 }}>ĐD</span> (Điểm danh) hoặc <span style={{ color: '#16a34a', fontWeight: 700 }}>GS</span> (Giám sát) để chọn vai trò cho GV.
                            </p>
                                            ...
                                            >
                                                ...
                                                <div style={{ display: 'flex', gap: 6 }}>
                                                    ...
                                                    <button
                                                        ...
                                                        onClick={() => addGV(gv, 1)}
                                                        title="Thêm với vai trò Giám sát"
                                                    >GS</button>
                                                </div>
                                            </div>
                                        );
                ...
                <div className="modal-overlay open">
                    <div className="modal-box" style={{ maxWidth: 440 }}>
                        ...
                        <div className="modal-body">
                            ...
                            <div className="form-group" style={{ display: 'flex', alignItems: 'flex-start', gap: 10, background: '#f8fafc', padding: 12, borderRadius: 8, border: '1px solid #e2e8f0' }}>
                                <input
                                    type="checkbox"
                                    id="forceOverwrite"
                                    checked={applyForce}
                                ...
                                <label htmlFor="forceOverwrite" style={{ cursor: 'pointer', marginBottom: 0 }}>
                                    <strong style={{ color: '#0f172a' }}>Đồng bộ & ghi đè toàn bộ tuần (Thứ 2 – Thứ 5)</strong>
                                    <div style={{ fontSize: '0.8rem', color: '#64748b', marginTop: 2 }}>
                                        Xóa các phân công cũ từ T2 đến T5 của tuần đã chọn và cập nhật chính xác theo lịch khung hiện tại (Khuyên dùng khi vừa chỉnh sửa lịch cố định). Thứ 6 không bị ảnh hưởng.
                                    </div>
                                </label>
                            </div>
                        </div>
