...
import { formatLopList, sortStudentsForRoom, splitStudentsByTeachers } from '../../utils/stringUtils';
...
export default function DiemDanhAn() {
    ...
    // Danh sách học sinh trong phòng sau khi lọc tìm kiếm (hỗ trợ tìm theo tên hoặc mã HS 1, 2, 10, 180...)
                            ...
                            <div style={{ display: 'flex', gap: 8, marginTop: 4, flexWrap: 'wrap', alignItems: 'center' }}>
                                {lopArr && lopArr.length > 0 && (
                                    <div style={{
                                        ...
                                        <i className="fas fa-filter" style={{ marginTop: 2, color: 'var(--primary)' }}></i>
                                        <span>
                        ...
                        <>
                            ...
                            <div id="dd-student-area">
                                {!selectedPhong ? (
                                    ...
                                    <div className="dd-empty" style={{ color: '#0ea5e9' }}>
